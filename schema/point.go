...
func GetPointSchema() *PointSchema {
	...
	m.UnitFrom.Title = "Units"
	m.UnitFrom.Options = unit
	m.UnitFrom.EnumName = names
	m.UnitFrom.Default = "disabled"

	m.UnitTo.Title = "Convert Unit To"
	m.UnitTo.Options = unit
	m.UnitTo.EnumName = names
	m.UnitTo.Default = "disabled"
	schema.Set(m)
	return m
}
