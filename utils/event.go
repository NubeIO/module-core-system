...
// CheckEventScheduleEntry checks if there is a EventScheduleEntry that matches
...
// CheckEventScheduleCollection checks if there is a EventScheduleEntry in the provided EventScheduleCollection
// that matches the specified schedule Name and is currently within the scheduled period.
...
// EventCheck checks all Event Schedules in the payload for active periods.
// It returns a combined ScheduleCheckerResult of all Event Schedules.
